<div class="row">
                  <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" value="{{ old('first_name') }}"  name="first_name" id="first_name" class="form-control @error('first_name') is-invalid @enderror">
                        @error('first_name') 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" value="{{ old('last_name') }}"  name="last_name" id="last_name" class="form-control @error('last_name') is-invalid @enderror">
                        @error('last_name') 
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <select name="company_id" value="{{ old('company_id') }}"  id="company_id" class="form-control @error('company_id') is-invalid @enderror">
                        @error('company_id') 
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
